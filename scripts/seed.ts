  ...
  const PRODUCTS = [
    {
      ...
      variants: makeVariants(19500000, LEHENGA_SIZES, [{ name: 'Sindoori Crimson Red', hex: '#C41E3A' }], '/images/products/shahi-sindoori-red-bridal-lehenga-0929.webp'),
    ...
    },
    {
      ...
      variants: makeVariants(18800000, LEHENGA_SIZES, [{ name: 'Blossom Pink', hex: '#F472B6' }], '/images/products/mumtaz-blossom-pink-bridal-lehenga-0994.webp'),
