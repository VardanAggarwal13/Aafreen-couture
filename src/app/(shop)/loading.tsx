      ...
      <div className="w-full bg-[#FAF5EE] border-b border-[#E8D4BE]">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 py-6 sm:py-8 lg:py-10 text-center">
          ...
          <div className="flex items-center justify-center gap-2 mb-3">
            <div className="h-2.5 w-12 bg-[#E8D8C8]/60 rounded-md animate-pulse" />
            <span className="text-[#C49A5A] text-xs">/</span>
            <div className="h-2.5 w-20 bg-[#E8D8C8]/80 rounded-md animate-pulse" />
          </div>

          {/* Title shimmer */}
          <div className="h-8 sm:h-10 w-48 sm:w-64 bg-[#E8D8C8]/70 rounded-md mx-auto animate-pulse my-2" />

          {/* Subtitle shimmer */}
          <div className="h-3 w-72 sm:w-96 bg-[#E8D8C8]/50 rounded-md mx-auto animate-pulse mt-2" />
        </div>
      </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3.5 sm:gap-5 lg:gap-7">
          {Array.from({ length: 8 }, (_, i) => (
            <div key={i} className="flex flex-col gap-3">
              <div className="aspect-[4/5] bg-white rounded-xl relative overflow-hidden shadow-sm">
              ...
              <div className="space-y-1.5 px-0.5">
                ...
                <div className="h-3 bg-[#C49A5A]/40 rounded-md animate-pulse w-1/3 pt-1" />
              </div>
            </div>
          ))}
        </div>
