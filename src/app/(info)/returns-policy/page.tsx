...
export default async function ReturnsPolicyPage() {
  const cms = await cmsRepository.findBySlug('returns-policy');
  return (
    <main className="min-h-screen bg-[#FAF7F2] text-[#221617]">
      {/* Luxury Editorial Hero */}
      <InfoHeroBanner
        badge={cms?.heroBadge ?? 'Aafreen Atelier Fitting Protocols'}
        title={cms?.heroTitle ?? 'Exchange & Returns'}
        italicTitle={cms?.heroItalicTitle ?? 'Client Care & Fitting Guarantee'}
        subtitle={
          cms?.heroSubtitle ??
        ...
        metaInfo={cms?.heroMetaInfo ?? 'Effective Season 2026 · Compliant with Consumer Protection (E-Commerce) Rules'}
      />
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 py-10 sm:py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <article className="lg:col-span-8 space-y-8 font-sans text-sm sm:text-base text-[#5C554E] leading-relaxed">
            {/* Section 1: Overview */}
            <section id="sec-overview" className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm scroll-mt-36">
            ...
            <section id="sec-exchange-flow" className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm scroll-mt-36">
              <div className="flex items-center gap-3 mb-4 pb-3 border-b border-[#E8D8C8]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
                <div className="bg-[#FAF7F2] p-5 rounded-lg border border-[#E8D8C8] flex flex-col justify-between">
                  <div>
                    <span className="font-mono text-xs font-bold text-[#A67C52] mb-1 block">Step 01</span>
                    <h3 className="font-sans font-semibold text-xs text-[#221617] mb-1.5">Notify Concierge</h3>
                ...
                <div className="bg-[#FAF7F2] p-5 rounded-lg border border-[#E8D8C8] flex flex-col justify-between">
                  <div>
                    ...
                    <h3 className="font-sans font-semibold text-xs text-[#221617] mb-1.5">Reverse Pickup</h3>
                    <p className="text-[11.5px] text-[#6E6A66] leading-relaxed">
                ...
                <div className="bg-[#FAF7F2] p-5 rounded-lg border border-[#E8D8C8] flex flex-col justify-between">
                  <div>
                    ...
                    <h3 className="font-sans font-semibold text-xs text-[#221617] mb-1.5">Alteration or Swap</h3>
                    <p className="text-[11.5px] text-[#6E6A66] leading-relaxed">
            ...
            <section id="sec-exchange-policy" className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm scroll-mt-36">
              <div className="flex items-center gap-3 mb-4 pb-3 border-b border-[#E8D8C8]">
            ...
            <section id="sec-custom-bridal" className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm scroll-mt-36">
              <div className="flex items-center gap-3 mb-4 pb-3 border-b border-[#E8D8C8]">
              ...
              <div className="bg-[#FAF7F2] p-5 border-l-3 border-[#C49A5A] rounded-lg space-y-2">
                <span className="font-sans text-[#221617] block text-xs font-semibold">
            ...
            <section id="sec-unboxing-video" className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm scroll-mt-36">
              <div className="flex items-center gap-3 mb-4 pb-3 border-b border-[#E8D8C8]">
              ...
              <div className="space-y-2.5 bg-[#FAF7F2] p-5 border border-[#E8D8C8] rounded-lg text-xs">
            ...
            <section id="sec-ineligible" className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm scroll-mt-36">
              <div className="flex items-center gap-3 mb-4 pb-3 border-b border-[#E8D8C8]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                <div className="bg-[#FAF7F2] p-3.5 border border-[#E8D8C8] rounded-lg">
            ...
            <section id="sec-refused-parcels" className="bg-gradient-to-b from-[#FAF7F2] to-white p-6 sm:p-8 rounded-2xl shadow-md scroll-mt-36">
            ...
            <section id="sec-cancellation" className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm scroll-mt-36">
              <div className="flex items-center gap-3 mb-4 pb-3 border-b border-[#E8D8C8]">
            ...
            <section id="sec-refund-timelines" className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm scroll-mt-36">
              <div className="flex items-center gap-3 mb-4 pb-3 border-b border-[#E8D8C8]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs pt-1">
                <div className="bg-[#FAF7F2] p-4 rounded-lg border border-[#E8D8C8]">
            ...
            <section id="sec-concierge" className="bg-[#221617] text-white p-6 sm:p-8 rounded-2xl shadow-md scroll-mt-36">
